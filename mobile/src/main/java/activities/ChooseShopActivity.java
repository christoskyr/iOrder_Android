...
public class ChooseShopActivity extends Activity {
    ...
    private static final String TAG_LATIDUDE = "latitude";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new HttpAsyncTask().execute("https://myiorderapp.herokuapp.com/api/v1/stores");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < stores.length(); i++) {
                    ...
                    final String latitude = c.getString(TAG_LATIDUDE);
                    final String longitude = c.getString(TAG_LONGITUDE);
                    ...
                    final ListAdapter adapter = new SimpleAdapter(ChooseShopActivity.this, storeList,
                            ...
                            new String[]{TAG_ID, TAG_NAME, TAG_LATIDUDE, TAG_LONGITUDE}, new int[]{
                            R.id.id, R.id.title, R.id.latitude, R.id.longitude});
                        ...
                        public void onItemClick(AdapterView<?> parent, View view,
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    ...
                                    String store_latitude = storeList.get(position).get("latitude").toString();
                                    String store_longitude = storeList.get(position).get("longitude").toString();
                                    i.putExtra("latitude", store_latitude);
                                    i.putExtra("longitute", store_longitude);
                                    iorder.setLatitude(store_latitude);
                                    iorder.setLongitude(store_longitude);
